class PagesController < ApplicationController
  ...
  def dashboard
    ...
    @confirmed_shelter_caretakings = Caretaking.where(animal: @shelter_animals, status: 1) # bookings the shelter has received
    @pending_shelter_caretakings = Caretaking.where(animal: @shelter_animals, status: 0) # bookings the shelter has received
