class CaretakingsController < ApplicationController
  def create
    ...
    if @caretaking.save
      flash[:confirmation] = "The booking request for your volunteering slot has successfully been sent and is currently pending. Please check your dashboard for updates."
